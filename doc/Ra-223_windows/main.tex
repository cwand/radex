...
A measurement of a \isotope[223]{Ra} source with an activity of $\sim 
...
\begin{figure}[h]
    ...
    \caption{Spectrum measured from a \isotope[223]{Ra} source (black line). 
...
presence of \isotope[223]{Ra} can be detected. The windows are also shown in 
